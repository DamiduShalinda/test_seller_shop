-- Improve handover RPC to account for items already stocked to the target shop.
-- If some items are already in the shop (e.g., admin stocked by barcode), only move the remainder.
