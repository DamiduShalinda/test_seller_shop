-- Ensure collector RPCs exist in environments that already ran the previous
-- migration and force PostgREST to reload its schema cache so the functions
-- are callable right away.
